...
\begin{centering}
\framebox{\begin{minipage}[t]{1\columnwidth}
\center{Functionality $\mathcal{F}_{AAC}$ running with party $P_1,\ldots,P_N$ and
        adversary $\mathcal{S}$ proceeds as follows}
\begin{enumerate}
...
The protocol SIGMIX running with parties $P_1,\ldots,P_N$ in the 
